    ...
    <div className="mx-auto max-w-3xl space-y-6 p-4 py-10">
      ...
      <Card>
        ...
        <div className="space-y-5 text-sm leading-relaxed text-slate-700">
          <section>
            <h2 className="mb-1 text-base font-bold text-slate-900">1. What we collect</h2>
            <p>
          ...
          <section>
            <h2 className="mb-1 text-base font-bold text-slate-900">2. Why we collect it</h2>
            <p>
          ...
          <section>
            <h2 className="mb-1 text-base font-bold text-slate-900">3. How it&apos;s stored</h2>
            <p>
          ...
          <section>
            <h2 className="mb-1 text-base font-bold text-slate-900">4. Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="mb-1 text-base font-bold text-slate-900">5. Retention</h2>
            <p>
          ...
          <section>
            <h2 className="mb-1 text-base font-bold text-slate-900">6. Your rights</h2>
            <p>
          ...
          <section>
            <h2 className="mb-1 text-base font-bold text-slate-900">7. Changes to this policy</h2>
            <p>
